    ...
    return (
        <div>
            ...
            <div className='text-center m-10'>
                <Link to='/contact' className=' bg-indigo-700 text-2xl p-3 rounded text-white'>Contact Us</Link>
            </div>
        </div>
    )
}
